...
public class Alipay extends Controller {
    ...
    // 服务器异步通知页面路径
    static String notify_url = "http://www.xxx.com/WS_WAP_PAYWAP-JAVA-UTF-8/notify_url.jsp";
    // 需http://格式的完整路径，不能加?id=123这类自定义参数
    // 页面跳转同步通知页面路径
    static String call_back_url = "http://127.0.0.1:8080/WS_WAP_PAYWAP-JAVA-UTF-8/call_back_url.jsp";
    // 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
    // 操作中断返回地址
    static String merchant_url = "http://127.0.0.1:8080/WS_WAP_PAYWAP-JAVA-UTF-8/xxxxxx.jsp";
